...
echo "==========================================="
echo ""
echo "1. 📰 MEDIUM (Articles 5-7 min):"
...
echo ""
echo "2. 📚 LEANPUB (Livres complets):"
...
echo ""
echo "4. 📢 ANNONCE COORDONNÉE:"
echo "   • LinkedIn/Twitter avec lien vers Medium"
echo "   • Communautés dev/AI avec lien Leanpub"

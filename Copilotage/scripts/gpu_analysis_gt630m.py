...
def main():
    ...
    analysis_path = f"/home/stephane/GitHub/PaniniFS-1/Copilotage/scripts/gpu_analysis_gt630m_{timestamp}.json"
    with open(analysis_path, 'w', encoding='utf-8') as f:
        json.dump(complete_analysis, f, indent=2, ensure_ascii=False)
    
    # Créer script test
    test_script_path = f"/home/stephane/GitHub/PaniniFS-1/Copilotage/scripts/test_gpu_capabilities.py"

...
class WorkflowTester:
    ...
    def test_notebook_generation(self):
        ...
        notebook_path = f"{self.workspace_root}/Copilotage/colab_notebooks/semantic_processing_accelerated.ipynb"
        ...
        if os.path.exists(notebook_path):
            ...
            try:
                ...
                ], cwd=f"{self.workspace_root}/Copilotage/scripts", 
    ...
    def generate_test_report(self):
        ...
        # Sauvegarder rapport
        report_file = f"{self.workspace_root}/Copilotage/test_workflow_report.json"

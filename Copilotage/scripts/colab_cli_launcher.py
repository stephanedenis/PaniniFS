...
class ColabCLILauncher:
    ...
    def __init__(self):
        ...
        self.colab_scripts_dir = f"{self.workspace_root}/Copilotage/colab_notebooks"
        self.results_dir = f"{self.workspace_root}/Copilotage/colab_results"
...
GITHUB_URL="https://github.com/stephanedenis/PaniniFS/blob/master/Copilotage/colab_notebooks/{notebook_name}.ipynb"
COLAB_URL="https://colab.research.google.com/github/stephanedenis/PaniniFS/blob/master/Copilotage/colab_notebooks/{notebook_name}.ipynb"
...
if __name__ == "__main__":
    ...
    example_script_path = f"{launcher.workspace_root}/Copilotage/scripts/semantic_processing_example.py"

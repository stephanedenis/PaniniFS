...
ALICE_KEY_PASSAGES = {
    ...
    "ch01_opening": {
        ...
        "markers": {
            ...
            "fi": ["alkoi jo ikävystyä", "istua sisarensa vieressä", "valkoista Kaniinia"],
        },
        "expected_atoms": ["PERCEPTION", "COGNITION", "EMOTION", "MOUVEMENT"],
    ...
    "ch07_tea_party": {
        ...
        "markers": {
            ...
            "eo": ["freneza Tekunveno", "korvo similas skribtablon", "ne estas loko"],
    ...
    "ch05_caterpillar": {
        ...
        "markers": {
            ...
            "eo": ["Kiu vi estas", "Raŭpo", "mi apenaŭ scias", "ŝanĝoj"],
...
CANDIDE_KEY_PASSAGES = {
    ...
    "ch03_war": {
        ...
        "markers": {
            ...
            "fi": ["sankarillista teurastusta", "pistimet"],
        },
        "expected_atoms": ["DESTRUCTION", "MOUVEMENT", "EMOTION", "PERCEPTION"],
...
ATOM_KEYWORDS = {
    ...
    "EMOTION": {
        "en": ["happy", "sad", "angry", "afraid", "fear", "love", "hate", "joy",
               "sorrow", "cry", "laugh", "surprise", "wonder", "anxious", "delight"],
        "fr": ["heureux", "triste", "fâché", "peur", "aimer", "haïr", "joie",
               "pleur", "rire", "surprise", "étonner", "inquiet", "colère"],
        "de": ["glücklich", "traurig", "böse", "Angst", "lieben", "hassen",
               "Freude", "weinen", "lachen", "überraschen", "Zorn", "Wut"],
        "it": ["felice", "triste", "arrabbiato", "paura", "amare", "odiare",
               "gioia", "piangere", "ridere", "sorpresa", "rabbia"],
        "es": ["feliz", "triste", "enojado", "miedo", "amar", "odiar",
               "alegría", "llorar", "reír", "sorpresa", "ira"],
        "eo": ["feliĉa", "malĝoja", "kolera", "timo", "ami", "malami",
               "ĝojo", "plori", "ridi", "surprizi"],
        "fi": ["onnellinen", "surullinen", "vihainen", "pelko", "rakastaa",
               "ilo", "itkeä", "nauraa", "yllätys", "viha"],
    },
    "EXISTENCE": {
...
def map_atoms_to_concepts(atoms_detected):
    ...
    # Key concept-atom mappings (from PanLang v2)
    CONCEPT_MAPPINGS = {
        "ENNUI": {"EMOTION", "COGNITION"},
        "CURIOSITÉ": {"COGNITION", "PERCEPTION", "EMOTION"},
        "EXPLORER": {"MOUVEMENT", "PERCEPTION", "COGNITION"},
        "OBSERVER": {"PERCEPTION", "COGNITION"},
        "TOMBER": {"MOUVEMENT"},
        "DIALOGUE": {"COMMUNICATION"},
        "INTERROGER": {"COMMUNICATION", "COGNITION"},
        "IDENTITÉ": {"COGNITION", "EXISTENCE"},
        "QUESTIONNER": {"COMMUNICATION", "COGNITION"},
        "DOUTER": {"COGNITION", "EMOTION"},
        "JUGER": {"COGNITION", "DOMINATION"},
        "ORDONNER": {"COMMUNICATION", "DOMINATION"},
        "PUNIR": {"DOMINATION", "DESTRUCTION"},
        "CROIRE": {"COGNITION"},
        "EXISTER": {"EXISTENCE"},
        "COMBATTRE": {"MOUVEMENT", "DESTRUCTION"},
        "SOUFFRIR": {"EMOTION", "PERCEPTION"},
        "DÉTRUIRE": {"DESTRUCTION"},
        "CRÉER": {"CREATION"},
        "TRAVAILLER": {"CREATION", "MOUVEMENT"},
        "SAGESSE": {"COGNITION", "EVAL"},
        # Extended from v2 model
        "COLÈRE": {"EMOTION", "DOMINATION"},
        "PEUR": {"EMOTION", "PERCEPTION"},
        "AMOUR": {"EMOTION", "POSSESSION"},
        "FUIR": {"MOUVEMENT", "EMOTION"},
        "CHERCHER": {"MOUVEMENT", "COGNITION", "PERCEPTION"},
        "APPRENDRE": {"COGNITION", "PERCEPTION"},
        "ENSEIGNER": {"COMMUNICATION", "COGNITION"},
        "DOMINER": {"DOMINATION"},
        "POSSÉDER": {"POSSESSION"},
    }

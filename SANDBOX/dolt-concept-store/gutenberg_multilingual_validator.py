...
def map_atoms_to_concepts(atoms_detected):
    ...
    CONCEPT_MAPPINGS = {
        ...
        "ENNEMI": {"EMOTION", "DOMINATION", "DESTRUCTION"},
        ...
        "JUSTICE": {"COGNITION", "DOMINATION", "EXISTENCE", "EMOTION"},
        "LIBERTÉ": {"MOUVEMENT", "DOMINATION", "EXISTENCE"},
        "AIMER": {"EMOTION", "COMMUNICATION", "POSSESSION"},
        ...
        "RESSENTIR": {"COGNITION", "EMOTION"},
        "VIVRE": {"EXISTENCE", "EMOTION"},
        "DESIRER": {"POSSESSION", "EMOTION"},
        "HAIR": {"EMOTION", "DESTRUCTION", "DOMINATION"},
        "ACCUMULER": {"POSSESSION", "CREATION"},
        "DANSER": {"MOUVEMENT", "COMMUNICATION"},
    }

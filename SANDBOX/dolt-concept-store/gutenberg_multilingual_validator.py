...
ATOM_KEYWORDS = {
    "MOUVEMENT": {
        ...
        "fr": ["aller", "venir", "courir", "tomber", "marcher", "sauter", "bouger", "voler",
               "suivre", "poursuivre", "glisser", "errer", "descendre", "monter", "ramener"],
    ...
    "COMMUNICATION": {
        ...
        "fr": ["dire", "parler", "demander", "répondre", "appeler", "crier",
               "murmurer", "mot", "voix", "déclarer", "raconter", "question", "conversation"],
        ...
        "eo": ["diri", "paroli", "demandi", "respondi", "voki", "krii", "vorto", "voĉo",
               "prezenti", "argumenti", "atesti", "ricevi"],
        "fi": ["sanoa", "puhua", "kysyä", "vastata", "huutaa", "kuiskaa", "sana", "ääni",
               "jutella", "kertoa", "hymähtää"],
    },
    "CREATION": {
    ...
    "PLAY": {
        ...
        "eo": ["ludi", "ridi", "amuzo", "ludo", "ŝerco", "gaja",
               "feliĉa", "ĝojo", "festi"],
        "fi": ["leikkiä", "leikki", "nauraa", "hauska", "peli", "iloinen",
    ...
    "DESTRUCTION": {
        ...
        "fi": ["tuhota", "rikkoa", "tappaa", "leikata", "polttaa", "sota", "taistella",
               "myrsky", "maanjäristys", "haaksirikko"],
    },
    "POSSESSION": {
    ...
    "DOMINATION": {
        ...
        "eo": ["reĝo", "reĝino", "regi", "ordoni", "obei", "potenco", "juĝi", "puni", "leĝo",
               "senkapigi", "ekzekuti", "rifuzi", "fuŝregi", "elekti", "eliĝi"],
        "fi": ["kuningas", "kuningatar", "hallita", "käskeä", "totella", "valta", "tuomita", "laki"],
    },
    # ── v2.3: Abstract atoms (ABS) — mathematics, physics, formal structures ──
    "RELATION": {
        "en": ["relation", "function", "map", "mapping", "correspond", "connect",
               "link", "bind", "associate", "pair", "between", "proportion",
               "ratio", "equation", "equal", "equivalent"],
        "fr": ["relation", "fonction", "correspondance", "lier", "associer",
               "connexion", "rapport", "proportion", "équation", "égal",
               "équivalent", "entre", "paire"],
        "de": ["Beziehung", "Funktion", "Abbildung", "Zuordnung", "verbinden",
               "Verhältnis", "Gleichung", "gleich", "Proportion"],
        "it": ["relazione", "funzione", "corrispondenza", "legare", "associare",
               "rapporto", "equazione", "uguale", "proporzione"],
        "es": ["relación", "función", "correspondencia", "vincular", "asociar",
               "proporción", "ecuación", "igual", "equivalente"],
        "eo": ["rilato", "funkcio", "korespondo", "ligi", "asocii",
               "proporcio", "ekvacio", "egala"],
        "fi": ["suhde", "funktio", "vastaavuus", "yhdistää", "sitoa",
               "yhtälö", "suhdeluku", "vastaava"],
    },
    "STRUCTURE": {
        "en": ["structure", "system", "form", "pattern", "organize", "framework",
               "architecture", "network", "graph", "set", "group", "ring", "field",
               "space", "topology", "algebra", "lattice", "category"],
        "fr": ["structure", "système", "forme", "motif", "organiser", "réseau",
               "graphe", "ensemble", "groupe", "anneau", "corps", "espace",
               "topologie", "algèbre", "treillis", "catégorie"],
        "de": ["Struktur", "System", "Form", "Muster", "Ordnung", "Netzwerk",
               "Graph", "Menge", "Gruppe", "Ring", "Körper", "Raum",
               "Topologie", "Algebra", "Verband", "Kategorie"],
        "it": ["struttura", "sistema", "forma", "schema", "organizzare", "rete",
               "grafo", "insieme", "gruppo", "anello", "campo", "spazio",
               "topologia", "algebra", "reticolo", "categoria"],
        "es": ["estructura", "sistema", "forma", "patrón", "organizar", "red",
               "grafo", "conjunto", "grupo", "anillo", "cuerpo", "espacio",
               "topología", "álgebra", "retículo", "categoría"],
        "eo": ["strukturo", "sistemo", "formo", "ŝablono", "organizi", "reto",
               "grafeo", "aro", "grupo", "ringo", "kampo", "spaco"],
        "fi": ["rakenne", "järjestelmä", "muoto", "kuvio", "organisoida",
               "verkko", "joukko", "ryhmä", "rengas", "kunta", "avaruus",
               "topologia", "algebra"],
    },
    "INVARIANCE": {
        "en": ["invariant", "constant", "conserve", "preserve", "symmetry",
               "unchanged", "stable", "fixed", "permanent", "persist",
               "identity", "same", "maintain"],
        "fr": ["invariant", "constant", "conserver", "préserver", "symétrie",
               "inchangé", "stable", "fixe", "permanent", "persister",
               "identité", "même", "maintenir"],
        "de": ["invariant", "Konstante", "erhalten", "bewahren", "Symmetrie",
               "unverändert", "stabil", "fest", "beständig", "Identität"],
        "it": ["invariante", "costante", "conservare", "preservare", "simmetria",
               "stabile", "fisso", "permanente", "identità"],
        "es": ["invariante", "constante", "conservar", "preservar", "simetría",
               "estable", "fijo", "permanente", "identidad"],
        "eo": ["invarianto", "konstanto", "konservi", "simetrio", "stabila",
               "fiksa", "permanenta", "identeco"],
        "fi": ["invariantti", "vakio", "säilyttää", "symmetria", "muuttumaton",
               "vakaa", "pysyvä", "identiteetti"],
    },
    "RÉCURRENCE": {
        "en": ["recurrence", "recursion", "iterate", "repeat", "cycle", "loop",
               "induction", "sequence", "series", "periodic", "fractal",
               "self-reference", "again", "feedback"],
        "fr": ["récurrence", "récursion", "itérer", "répéter", "cycle", "boucle",
               "induction", "suite", "série", "périodique", "fractale",
               "autoréférence", "encore", "rétroaction"],
        "de": ["Rekurrenz", "Rekursion", "iterieren", "wiederholen", "Zyklus",
               "Schleife", "Induktion", "Folge", "Reihe", "periodisch", "Fraktal"],
        "it": ["ricorrenza", "ricorsione", "iterare", "ripetere", "ciclo",
               "induzione", "sequenza", "serie", "periodico", "frattale"],
        "es": ["recurrencia", "recursión", "iterar", "repetir", "ciclo",
               "inducción", "secuencia", "serie", "periódico", "fractal"],
        "eo": ["rekurenco", "rekursio", "ripeti", "ciklo", "indukto",
               "sekvenco", "serio", "perioda", "fraktalo"],
        "fi": ["toistuvuus", "rekursio", "iteroida", "toistaa", "sykli",
               "induktio", "jono", "sarja", "jaksoittainen", "fraktaali"],
    },
    "DUALITÉ": {
        "en": ["dual", "duality", "opposite", "complement", "inverse", "conjugate",
               "mirror", "contravariant", "covariant", "adjoint", "transpose",
               "antithesis", "counterpart"],
        "fr": ["dual", "dualité", "opposé", "complément", "inverse", "conjugué",
               "miroir", "contravariant", "covariant", "adjoint", "transposé",
               "antithèse", "contrepartie"],
        "de": ["dual", "Dualität", "Gegenteil", "Komplement", "Inverse", "Konjugiert",
               "Spiegel", "Adjungiert", "Transponiert", "Antithese"],
        "it": ["duale", "dualità", "opposto", "complemento", "inverso", "coniugato",
               "specchio", "aggiunto", "trasposto", "antitesi"],
        "es": ["dual", "dualidad", "opuesto", "complemento", "inverso", "conjugado",
               "espejo", "adjunto", "transpuesto", "antítesis"],
        "eo": ["duala", "dualeco", "kontraŭa", "komplemento", "inversa",
               "spegulo", "antitezo"],
        "fi": ["duaali", "duaalisuus", "vastakohta", "komplementti", "käänteinen",
               "peili", "adjungoitu", "antiteesi"],
    },
    "MESURE": {
        "en": ["measure", "metric", "distance", "size", "length", "area", "volume",
               "weight", "norm", "magnitude", "quantity", "dimension", "degree",
               "scale", "unit", "count", "calculate", "compute"],
        "fr": ["mesure", "métrique", "distance", "taille", "longueur", "aire",
               "volume", "poids", "norme", "grandeur", "quantité", "dimension",
               "degré", "échelle", "unité", "compter", "calculer"],
        "de": ["Maß", "Metrik", "Abstand", "Größe", "Länge", "Fläche",
               "Volumen", "Gewicht", "Norm", "Menge", "Dimension", "Grad",
               "Einheit", "zählen", "berechnen"],
        "it": ["misura", "metrica", "distanza", "dimensione", "lunghezza", "area",
               "volume", "peso", "norma", "grandezza", "quantità", "grado",
               "unità", "contare", "calcolare"],
        "es": ["medida", "métrica", "distancia", "tamaño", "longitud", "área",
               "volumen", "peso", "norma", "magnitud", "cantidad", "dimensión",
               "grado", "escala", "unidad", "contar", "calcular"],
        "eo": ["mezuro", "metriko", "distanco", "grando", "longo", "areo",
               "volumeno", "pezo", "normo", "kvanto", "dimensio", "unuo", "kalkuli"],
        "fi": ["mitta", "metriikka", "etäisyys", "koko", "pituus", "ala",
               "tilavuus", "paino", "normi", "määrä", "ulottuvuus", "yksikkö",
               "laskea"],
    },
    "ORDRE": {
        "en": ["order", "rank", "hierarchy", "sort", "sequence", "precede", "follow",
               "before", "after", "above", "below", "first", "last", "next",
               "minimum", "maximum", "least", "greatest", "monotone"],
        "fr": ["ordre", "rang", "hiérarchie", "trier", "séquence", "précéder",
               "suivre", "avant", "après", "dessus", "dessous", "premier",
               "dernier", "minimum", "maximum", "monotone"],
        "de": ["Ordnung", "Rang", "Hierarchie", "sortieren", "Reihenfolge",
               "vorausgehen", "folgen", "vor", "nach", "über", "unter",
               "Minimum", "Maximum", "monoton"],
        "it": ["ordine", "rango", "gerarchia", "ordinare", "sequenza",
               "precedere", "seguire", "prima", "dopo", "sopra", "sotto",
               "minimo", "massimo", "monotono"],
        "es": ["orden", "rango", "jerarquía", "ordenar", "secuencia",
               "preceder", "seguir", "antes", "después", "arriba", "abajo",
               "mínimo", "máximo", "monótono"],
        "eo": ["ordo", "rango", "hierarkio", "ordigi", "sekvenco",
               "antaŭi", "sekvi", "antaŭ", "post", "supre", "malsupre",
               "minimumo", "maksimumo"],
        "fi": ["järjestys", "arvo", "hierarkia", "lajitella", "sekvenssi",
               "edeltää", "seurata", "ennen", "jälkeen", "minimi", "maksimi",
               "monotoninen"],
    },
    # ── v2.5: Entity atoms (ENT) ──────────────────────────────────────────
    # Sources: NSM SOMETHING/SOMEONE/BODY, Jackendoff THING/PLACE,
    # Pustejovsky FORMAL/CONSTITUTIVE, BFO endurants, Spelke core knowledge
    "CHOSE": {
        "en": ["thing", "object", "something", "stuff", "item", "piece", "it",
               "this", "that", "what", "everything", "nothing", "anything"],
        "fr": ["chose", "objet", "truc", "machin", "ça", "ceci", "cela",
               "quoi", "tout", "rien", "quelque chose", "élément", "forme"],
        "de": ["Ding", "Sache", "Gegenstand", "Objekt", "etwas", "nichts",
               "alles", "Stück", "es", "dies", "das", "was"],
        "it": ["cosa", "oggetto", "qualcosa", "niente", "tutto", "pezzo",
               "roba", "questo", "quello", "ciò", "elemento"],
        "es": ["cosa", "objeto", "algo", "nada", "todo", "pieza",
               "esto", "eso", "aquello", "elemento", "trasto"],
        "eo": ["aĵo", "objekto", "io", "nenio", "ĉio", "afero",
               "peco", "tio", "ĉi tio", "kio"],
        "fi": ["asia", "esine", "tavara", "jokin", "mitään", "kaikki",
               "se", "tämä", "tuo", "mikä", "kapine"],
    },
    "AGENT": {
        "en": ["person", "someone", "people", "man", "woman", "child", "being",
               "creature", "who", "one", "king", "queen", "girl", "boy",
               "nobody", "everybody", "anybody", "somebody"],
        "fr": ["personne", "quelqu'un", "gens", "homme", "femme", "enfant",
               "être", "créature", "qui", "on", "roi", "reine", "fille",
               "garçon", "monde", "individu", "âme"],
        "de": ["Person", "Mensch", "Leute", "Mann", "Frau", "Kind", "Wesen",
               "Kreatur", "jemand", "niemand", "König", "Königin", "Mädchen",
               "Junge", "wer", "alle", "man"],
        "it": ["persona", "qualcuno", "gente", "uomo", "donna", "bambino",
               "essere", "creatura", "chi", "re", "regina", "ragazza",
               "ragazzo", "tutti", "nessuno"],
        "es": ["persona", "alguien", "gente", "hombre", "mujer", "niño",
               "ser", "criatura", "quien", "rey", "reina", "chica",
               "chico", "todos", "nadie"],
        "eo": ["persono", "iu", "homoj", "viro", "virino", "infano",
               "estaĵo", "kiu", "reĝo", "reĝino", "knabino",
               "knabo", "ĉiuj", "neniu"],
        "fi": ["henkilö", "joku", "ihmiset", "mies", "nainen", "lapsi",
               "olento", "kuka", "kuningas", "kuningatar", "tyttö",
               "poika", "kaikki", "kukaan"],
    },
    "CORPS": {
        "en": ["body", "flesh", "hand", "head", "blood", "bone", "skin",
               "arm", "leg", "face", "heart", "eye", "mouth", "finger",
               "foot", "hair", "neck", "shoulder", "belly", "back"],
        "fr": ["corps", "chair", "main", "tête", "sang", "os", "peau",
               "bras", "jambe", "visage", "cœur", "œil", "bouche", "doigt",
               "pied", "cheveux", "cou", "épaule", "ventre", "dos"],
        "de": ["Körper", "Fleisch", "Hand", "Kopf", "Blut", "Knochen", "Haut",
               "Arm", "Bein", "Gesicht", "Herz", "Auge", "Mund", "Finger",
               "Fuß", "Haar", "Hals", "Schulter", "Bauch", "Rücken"],
        "it": ["corpo", "carne", "mano", "testa", "sangue", "osso", "pelle",
               "braccio", "gamba", "viso", "cuore", "occhio", "bocca", "dito",
               "piede", "capelli", "collo", "spalla", "ventre", "schiena"],
        "es": ["cuerpo", "carne", "mano", "cabeza", "sangre", "hueso", "piel",
               "brazo", "pierna", "cara", "corazón", "ojo", "boca", "dedo",
               "pie", "pelo", "cuello", "hombro", "vientre", "espalda"],
        "eo": ["korpo", "karno", "mano", "kapo", "sango", "osto", "haŭto",
               "brako", "kruro", "vizaĝo", "koro", "okulo", "buŝo", "fingro",
               "piedo", "haro", "kolo", "ŝultro", "ventro", "dorso"],
        "fi": ["keho", "liha", "käsi", "pää", "veri", "luu", "iho",
               "käsivarsi", "jalka", "kasvot", "sydän", "silmä", "suu", "sormi",
               "jalka", "tukka", "kaula", "olkapää", "vatsa", "selkä"],
    },
    "LIEU": {
        "en": ["place", "here", "there", "where", "land", "home", "house",
               "garden", "room", "world", "city", "country", "ground",
               "field", "sea", "forest", "road", "way", "nowhere", "everywhere"],
        "fr": ["lieu", "place", "endroit", "ici", "là", "où", "pays",
               "terre", "maison", "jardin", "chambre", "monde", "ville",
               "champ", "mer", "forêt", "route", "chemin", "partout", "nulle part"],
        "de": ["Ort", "Platz", "Stelle", "hier", "dort", "wo", "Land",
               "Haus", "Garten", "Zimmer", "Welt", "Stadt", "Feld",
               "Meer", "Wald", "Weg", "Straße", "überall", "nirgends"],
        "it": ["luogo", "posto", "qui", "là", "dove", "paese", "terra",
               "casa", "giardino", "stanza", "mondo", "città", "campo",
               "mare", "bosco", "strada", "via", "ovunque", "da nessuna parte"],
        "es": ["lugar", "sitio", "aquí", "allí", "donde", "país", "tierra",
               "casa", "jardín", "habitación", "mundo", "ciudad", "campo",
               "mar", "bosque", "camino", "calle", "todas partes", "ninguna parte"],
        "eo": ["loko", "ĉi tie", "tie", "kie", "lando", "tero",
               "domo", "ĝardeno", "ĉambro", "mondo", "urbo", "kampo",
               "maro", "arbaro", "vojo", "strato", "ĉie", "nenie"],
        "fi": ["paikka", "täällä", "siellä", "missä", "maa", "koti",
               "talo", "puutarha", "huone", "maailma", "kaupunki", "pelto",
               "meri", "metsä", "tie", "polku", "kaikkialla", "ei missään"],
    },
    "MATIÈRE": {
        "en": ["water", "earth", "stone", "wood", "iron", "fire", "air",
               "matter", "sand", "snow", "gold", "salt", "blood", "glass",
               "silk", "dust", "smoke", "mud", "clay", "wool"],
        "fr": ["eau", "terre", "pierre", "bois", "fer", "feu", "air",
               "matière", "sable", "neige", "or", "sel", "sang", "verre",
               "soie", "poussière", "fumée", "boue", "argile", "laine"],
        "de": ["Wasser", "Erde", "Stein", "Holz", "Eisen", "Feuer", "Luft",
               "Stoff", "Sand", "Schnee", "Gold", "Salz", "Blut", "Glas",
               "Seide", "Staub", "Rauch", "Schlamm", "Ton", "Wolle"],
        "it": ["acqua", "terra", "pietra", "legno", "ferro", "fuoco", "aria",
               "materia", "sabbia", "neve", "oro", "sale", "sangue", "vetro",
               "seta", "polvere", "fumo", "fango", "argilla", "lana"],
        "es": ["agua", "tierra", "piedra", "madera", "hierro", "fuego", "aire",
               "materia", "arena", "nieve", "oro", "sal", "sangre", "vidrio",
               "seda", "polvo", "humo", "barro", "arcilla", "lana"],
        "eo": ["akvo", "tero", "ŝtono", "ligno", "fero", "fajro", "aero",
               "materio", "sablo", "neĝo", "oro", "salo", "sango", "vitro",
               "silko", "polvo", "fumo", "koto", "argilo", "lano"],
        "fi": ["vesi", "maa", "kivi", "puu", "rauta", "tuli", "ilma",
               "aine", "hiekka", "lumi", "kulta", "suola", "veri", "lasi",
               "silkki", "pöly", "savu", "muta", "savi", "villa"],
    },
    # ── v2.6: Quality atoms (QUAL category) ──────────────────────────────
    "BON": {
        "en": ["good", "well", "right", "fine", "nice", "kind", "gentle",
               "beautiful", "fair", "proper", "worthy", "pleasant", "sweet",
               "excellent", "noble", "honest", "virtuous", "blessed", "dear",
               "happy"],
        "fr": ["bon", "bien", "beau", "juste", "droit", "gentil", "aimable",
               "sage", "vertueux", "digne", "agréable", "doux", "noble",
               "honnête", "excellent", "heureux", "plaisant", "cher",
               "brave", "bienveillant"],
        "de": ["gut", "schön", "recht", "brav", "fein", "gütig", "edel",
               "freundlich", "anständig", "würdig", "angenehm", "lieb",
               "nett", "herrlich", "tugendhaft", "trefflich", "hold",
               "wacker", "glücklich", "selig"],
        "it": ["buono", "bello", "bravo", "gentile", "giusto", "bene",
               "dolce", "nobile", "degno", "onesto", "virtuoso", "caro",
               "amabile", "piacevole", "felice", "eccellente", "grazioso",
               "cortese", "leale", "valoroso"],
        "es": ["bueno", "bello", "justo", "amable", "digno", "bien",
               "dulce", "noble", "honesto", "virtuoso", "agradable",
               "excelente", "gentil", "querido", "feliz", "leal",
               "bondadoso", "grato", "valioso", "correcto"],
        "eo": ["bona", "bela", "ĝusta", "afabla", "digna", "bone",
               "dolĉa", "nobla", "honesta", "virtema", "agrabla",
               "bonega", "kara", "feliĉa", "plaĉa", "ĝentila",
               "bonkora", "aminda", "laŭdinda", "ĉarma"],
        "fi": ["hyvä", "kaunis", "oikea", "kiltti", "arvokas", "hyvin",
               "ihana", "jalo", "kunniallinen", "kelpo", "miellyttävä",
               "rakas", "suloinen", "erinomainen", "onnellinen", "lempeä",
               "hienotunteinen", "reilu", "mainio", "upea"],
    },
    "GRAND": {
        "en": ["big", "great", "large", "huge", "vast", "tall", "wide",
               "enormous", "grand", "immense", "mighty", "high", "long",
               "deep", "broad", "massive", "gigantic", "tremendous",
               "magnificent", "colossal"],
        "fr": ["grand", "gros", "vaste", "immense", "énorme", "haut",
               "large", "long", "profond", "puissant", "géant", "massif",
               "gigantesque", "majestueux", "magnifique", "colossal",
               "considérable", "imposant", "ample", "étendu"],
        "de": ["groß", "riesig", "gewaltig", "hoch", "weit", "mächtig",
               "lang", "tief", "breit", "enorm", "ungeheuer", "massiv",
               "gigantisch", "majestätisch", "kolossal", "erhaben",
               "beträchtlich", "ausgedehnt", "stattlich", "prächtig"],
        "it": ["grande", "vasto", "immenso", "enorme", "alto", "largo",
               "lungo", "profondo", "potente", "gigantesco", "massiccio",
               "maestoso", "magnifico", "colossale", "considerevole",
               "imponente", "ampio", "grandioso", "smisurato", "possente"],
        "es": ["grande", "vasto", "inmenso", "enorme", "alto", "ancho",
               "largo", "profundo", "poderoso", "gigantesco", "masivo",
               "majestuoso", "magnífico", "colosal", "considerable",
               "imponente", "amplio", "grandioso", "descomunal", "extenso"],
        "eo": ["granda", "vasta", "enorma", "alta", "larĝa", "longa",
               "profunda", "potenca", "giganta", "kolosa", "impona",
               "ampleksa", "grandioza", "majesta", "konsiderinda",
               "masiva", "senmezura", "multega", "vastega", "grandega"],
        "fi": ["suuri", "iso", "valtava", "korkea", "laaja", "pitkä",
               "syvä", "leveä", "mahtava", "jättiläismäinen", "massiivinen",
               "majesteettinen", "voimakas", "mittava", "huomattava",
               "muhkea", "vaikuttava", "loistava", "ääretön", "jykevä"],
    },
    "VRAI": {
        "en": ["true", "real", "right", "correct", "certain", "sure",
               "honest", "genuine", "authentic", "indeed", "truly",
               "really", "actual", "proper", "truth", "faithful",
               "sincere", "exact", "accurate", "veritable"],
        "fr": ["vrai", "réel", "juste", "certain", "sûr", "honnête",
               "sincère", "authentique", "véridique", "vraiment",
               "exact", "réellement", "fidèle", "véritable", "effectif",
               "vérace", "franc", "assurément", "certes", "en vérité"],
        "de": ["wahr", "echt", "richtig", "sicher", "gewiss", "ehrlich",
               "aufrichtig", "tatsächlich", "wirklich", "wahrlich",
               "wahrhaftig", "recht", "genau", "treu", "gerecht",
               "fürwahr", "gewisslich", "zuverlässig", "redlich", "lauter"],
        "it": ["vero", "reale", "giusto", "certo", "sicuro", "onesto",
               "sincero", "autentico", "veridico", "davvero", "veramente",
               "effettivo", "esatto", "fedele", "genuino", "invero",
               "leale", "verace", "veritiero", "verosimile"],
        "es": ["verdadero", "real", "cierto", "seguro", "honesto",
               "sincero", "auténtico", "veraz", "de veras", "realmente",
               "verdaderamente", "exacto", "fiel", "genuino", "efectivo",
               "leal", "franco", "certero", "verídico", "cabal"],
        "eo": ["vera", "reala", "ĝusta", "certa", "honesta", "aŭtentika",
               "sincera", "vere", "efektiva", "ekzakta", "fidela",
               "ĝenuina", "verama", "fakte", "konfirmita", "prava",
               "fidinda", "nefalsa", "senduba", "sendube"],
        "fi": ["tosi", "todellinen", "oikea", "varma", "rehellinen",
               "aito", "vilpitön", "totuudenmukainen", "todella",
               "oikeasti", "tarkka", "uskollinen", "luotettava",
               "todenmukainen", "autenttinen", "tosiasiallinen",
               "varmasti", "kiistaton", "ehdoton", "pätevä"],
    },
    "INTENSE": {
        "en": ["very", "much", "deeply", "strongly", "extremely", "greatly",
               "intensely", "terribly", "highly", "utterly", "exceedingly",
               "immensely", "fiercely", "violently", "passionately",
               "profoundly", "desperately", "overwhelmingly", "furiously",
               "mightily"],
        "fr": ["très", "beaucoup", "profondément", "fortement",
               "extrêmement", "intensément", "terriblement", "vivement",
               "passionnément", "furieusement", "violemment",
               "ardemment", "désespérément", "follement", "éperdument",
               "infiniment", "considérablement", "prodigieusement",
               "formidablement", "effroyablement"],
        "de": ["sehr", "viel", "tief", "stark", "äußerst", "heftig",
               "zutiefst", "ungeheuer", "gewaltig", "leidenschaftlich",
               "furchtbar", "schrecklich", "ungemein", "außerordentlich",
               "überaus", "höchst", "unendlich", "maßlos",
               "unsäglich", "inbrünstig"],
        "it": ["molto", "assai", "profondamente", "fortemente",
               "estremamente", "intensamente", "terribilmente",
               "violentemente", "appassionatamente", "furiosamente",
               "immensamente", "disperatamente", "enormemente",
               "infinitamente", "prodigiosamente", "oltremodo",
               "follemente", "ardentemente", "smisuratamente", "fieramente"],
        "es": ["muy", "mucho", "profundamente", "fuertemente",
               "extremadamente", "intensamente", "terriblemente",
               "violentamente", "apasionadamente", "furiosamente",
               "inmensamente", "desesperadamente", "enormemente",
               "infinitamente", "sumamente", "extraordinariamente",
               "ardientemente", "locamente", "ferozmente", "sobremanera"],
        "eo": ["tre", "multe", "profunde", "forte", "ekstreme",
               "intense", "terure", "ege", "grandege", "furiozege",
               "violente", "pasie", "senreziste", "senlime",
               "nekredeble", "eksterordinare", "freneze", "arde",
               "despere", "ĝismorte"],
        "fi": ["hyvin", "paljon", "syvästi", "voimakkaasti", "erittäin",
               "äärimmäisen", "rajusti", "kiihkeästi", "hirveästi",
               "suunnattomasti", "epätoivoisesti", "tavattomasti",
               "ankarasti", "tulisesti", "uskomattoman", "pohjattomasti",
               "sanomattoman", "kohtuuttomasti", "hillittömästi",
               "järjettömästi"],
    },
    "ANCIEN": {
        "en": ["old", "ancient", "former", "past", "once", "aged",
               "ancestral", "previous", "original", "antique", "archaic",
               "primeval", "bygone", "olden", "venerable", "elder",
               "long ago", "aforetime", "primitive", "timeworn"],
        "fr": ["vieux", "ancien", "jadis", "autrefois", "passé",
               "antique", "âgé", "révolu", "ancestral", "archaïque",
               "primitif", "originel", "vénérable", "aïeul", "antérieur",
               "séculaire", "immémorial", "désuet", "suranné", "paternel"],
        "de": ["alt", "einstig", "ehemalig", "vergangen", "antik",
               "uralt", "früher", "einst", "altertümlich", "alters",
               "greise", "ehrwürdig", "vormalig", "urzeitlich",
               "vorig", "vormals", "altehrwürdig", "urtümlich",
               "archäisch", "patriarchalisch"],
        "it": ["vecchio", "antico", "passato", "remoto", "originario",
               "ancestrale", "arcaico", "primitivo", "primordiale",
               "venerabile", "vetusto", "anteriore", "un tempo",
               "avito", "annoso", "secolare", "antecedente",
               "decrepito", "immemoriale", "prisco"],
        "es": ["viejo", "antiguo", "pasado", "anterior", "remoto",
               "ancestral", "arcaico", "primitivo", "primordial",
               "venerable", "vetusto", "añejo", "otrora", "antaño",
               "secular", "originario", "precedente", "inmemorial",
               "longevo", "caduco"],
        "eo": ["malnova", "antikva", "pasinta", "iama", "pra-",
               "arkaika", "praula", "pratempo", "origina",
               "antaŭa", "malnova", "venerinda", "prapatra",
               "prahistoria", "kaduka", "eks-", "iamtempa",
               "pramonda", "praepoka", "pratipa"],
        "fi": ["vanha", "muinainen", "entinen", "ikivanha", "alkuperäinen",
               "esihistoriallinen", "muinaisaikainen", "kunnianarvoisa",
               "edeltävä", "aikaisempi", "iäkäs", "harmaapäinen",
               "antiikkinen", "primitiivinen", "ikiaikainen", "mennyt",
               "ennen", "ammoin", "vanhakantainen", "perinnäinen"],
    },
}
